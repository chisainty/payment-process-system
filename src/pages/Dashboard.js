    ...
    <>
              ...
              <a className="navbar-brand" href="index-2.html">
                <span className="brand-logo">
                  <img
                    ...
                    src="./app-assets/images/logo/sim-card3.png"
                  />
                </span>
                <h2 className="brand-text">Simsplug</h2>
              </a>
            </li>
              ...
              <div className="row match-height">
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="card">
                    ...
                    <div className="card-body p-0">
                      <div
                        id="goal-overview-radial-bar-chart"
                        className="my-2"
                      />
      ...
      <div className="customizer d-none d-md-block">
        <a
          ...
          href="#"
        >
          <i className="spinner" data-feather="settings" />
        </a>
            ...
            <div className="d-flex">
              <div className="form-check me-1">
                <input
                  ...
                  id="skinlight"
                  name="skinradio"
                  className="form-check-input layout-name"
                  defaultChecked
                  data-layout
                />
                <label className="form-check-label" htmlFor="skinlight">
                  Light
                </label>
              </div>
              <div className="form-check me-1">
                ...
                />
                <label className="form-check-label" htmlFor="skinbordered">
                  Bordered
                </label>
              </div>
              <div className="form-check me-1">
                ...
                />
                <label className="form-check-label" htmlFor="skindark">
                  Dark
                </label>
              </div>
              <div className="form-check">
                ...
                />
                <label className="form-check-label" htmlFor="skinsemidark">
                  Semi Dark
                </label>
              </div>
            </div>
            ...
            <div className="d-flex">
              <div className="form-check me-1">
                <input
                  ...
                  defaultChecked
                />
                <label className="form-check-label" htmlFor="layout-width-full">
                  Full Width
                </label>
              </div>
              <div className="form-check me-1">
          ...
          <div className="customizer-navbar px-2">
            <div id="customizer-navbar-colors">
              ...
              <ul className="list-inline unstyled-list">
                ...
                />
                <li
                  className="color-box bg-secondary"
            ...
            <div className="d-flex">
              <div className="form-check me-1">
                <input
                  ...
                  defaultChecked
                />
                <label className="form-check-label" htmlFor="nav-type-floating">
                  Floating
                </label>
              </div>
              <div className="form-check me-1">
                <input
                  ...
                  className="form-check-input"
                />
                <label className="form-check-label" htmlFor="nav-type-sticky">
                  Sticky
                </label>
              </div>
              <div className="form-check me-1">
                <input
                  ...
                  className="form-check-input"
                />
                <label className="form-check-label" htmlFor="nav-type-static">
                  Static
                </label>
              </div>
              <div className="form-check">
                <input
                  ...
                  className="form-check-input"
                />
                <label className="form-check-label" htmlFor="nav-type-hidden">
                  Hidden
                </label>
              </div>
            </div>
